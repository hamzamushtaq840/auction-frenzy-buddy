    ...
    const handleJob = (e) => {
        ...
        if (startTime === "" || endTime === "") {
            ...
            if (imageURL === "") {
                ...
                axios.post("http://localhost:5000/api/Sellitem", data, { withCredentials: true })
                    .then((res) => {
                        console.log(res);
                        if (res.status === 200) {
    ...
    return (
        <div className={styles.Main}>
            <div className={styles.imageContainer}>
                ...
                <div className={styles.h1}><h1>Bid An Item</h1></div>
            ...
            <form className={styles.formContainer} ref={formRef} onSubmit={(e) => handleJob(e)}>
                ...
                <TextField className={styles.input} required name='title' id="outlined-basic" label="T I T L E" size='small' variant="outlined" />
                <TextField className={styles.inputDescription} required name='description' multiline rows={9} id="outlined-basic" label="DESCRIPTION" size='small' type="number" variant="outlined" />
                <FormControl >
                ...
                <Stack component="form" spacing={2}>
                    <TextField required id="datetime-local" label="Bid Start Time" type="datetime-local" size='small' value={startTime} onChange={(e) => setStartTime(e.target.value)} sx={{ width: 250 }} InputLabelProps={{ shrink: true, }} />
